...
const CategoryFilter = ({ 
  ...
  const groupLabelClass = "text-xs uppercase tracking-wide text-muted-foreground font-medium";
  ...
  return (
    <div className="bg-card border rounded-lg p-6 space-y-5">
      ...
      <div className="space-y-2">
        <span className={groupLabelClass}>Type de flux</span>
        <div className="space-y-2">
          <Button
      ...
      {user && onViewModeChange && (
        <div className="space-y-2">
          <span className={groupLabelClass}>Affichage</span>
      ...
      {user && onShowReadArticlesChange && (
        <div className="space-y-2">
          <span className={groupLabelClass}>Articles lus</span>
          <div className="flex flex-wrap gap-2">
            <Button
      ...
      {onDateFilterChange && showFollowedOnly && !showDiscoveryMode && (
        <div className="space-y-2">
          <span className={groupLabelClass}>Période</span>
          <div className="flex flex-wrap gap-2">
            <Button
